    ...
    <div dir="rtl" className="flex flex-col gap-4">
      ...
      <div className="flex flex-col gap-4 bg-gray-100 p-4 ">
        ...
        <div>
          ...
          {activeInternet === "conversation" && <Conversation />}
