...
import { useActiveNavar } from "../Store/activeNavar";
import { useNavigate } from "react-router";

const NavarBottom = () => {
  const { activeNavar, setActiveNavar } = useActiveNavar();
  const { t } = useTranslation();
  const changePage = useNavigate();
  return (
    <div
      dir="rtl"
      className="p-2 flex items-center justify-between bg-white fixed bottom-0 right-0 left-0"
    >
      <div
        onClick={() => {
          setActiveNavar("home");
        ...
        className={clsx(
          ...
          activeNavar === "home" ? "bg-gray-100" : "bg-white",
        )}
      >
        <svg
          fill="none"
        ...
        >
          ...
          <path
            className={clsx(
              activeNavar === "home" ? "stroke-blue-400" : "stroke-[#808080]",
            )}
            strokeLinecap="round"
          ...
          <path
            className={clsx(
              activeNavar === "home" ? "stroke-[#ff4f00]" : "stroke-[#808080]",
            )}
            strokeLinecap="round"
            strokeLinejoin="round"
            strokeWidth="1.5"
        ...
        <p
          className={clsx(
            "text-[12px]",
            activeNavar === "home" ? "text-blue-400" : "text-[#808080]",
          )}
        >
          {t("mainPage.home")}
        </p>
      ...
      <div
        ...
        className={clsx(
          "flex flex-col justify-center gap-2 items-center py-2.5 px-5 rounded-lg",
          activeNavar === "char" ? "bg-gray-200" : "bg-white",
        )}
      >
        <svg
          fill="none"
        ...
        >
          ...
          <path
            className={clsx(
              activeNavar === "char" ? "stroke-blue-400" : "stroke-[#808080]",
            )}
            strokeLinecap="round"
            strokeLinejoin="round"
            strokeWidth="1.5"
          ...
          <path
            className={clsx(
              activeNavar === "char" ? "fill-[#ff4f00]" : "fill-[#808080]",
            )}
        ...
        <p
          className={clsx(
            "text-[12px]",
            activeNavar === "char" ? "text-blue-400" : "text-[#808080]",
          )}
        >
          {t("mainPage.title2")}
        </p>
      ...
      <div
        ...
        className={clsx(
          ...
          activeNavar === "packages" ? "bg-gray-200" : "bg-white",
        )}
      >
        <svg
          fill="none"
        ...
        <p
          className={clsx(
            "text-[11px]",
            activeNavar === "packages" ? "text-blue-400" : "text-[#808080]",
          )}
        >
          {t("mainPage.packages")}
        </p>
      ...
      <div
        ...
        className={clsx(
          ...
          activeNavar === "work" ? "bg-gray-100" : "bg-white",
        )}
      >
        <svg
          fill="none"
        ...
        >
          ...
          <path
            className={clsx(
              activeNavar === "work" ? "stroke-[#ff4f00]" : "stroke-[#808080]",
            )}
            strokeLinecap="round"
            strokeLinejoin="round"
            strokeWidth="1.5"
          ...
          <path
            className={clsx(
              activeNavar === "work" ? "stroke-blue-400" : "stroke-[#808080]",
            )}
            strokeLinecap="round"
            strokeLinejoin="round"
            strokeWidth="1.5"
        ...
        <p
          className={clsx(
            "text-[11px]",
            activeNavar === "work" ? "text-blue-400" : "text-[#808080]",
          )}
        >
          {t("mainPage.work")}
        </p>
      ...
      <div
        ...
        className={clsx(
          ...
          activeNavar === "parse" ? "bg-gray-100" : "bg-white",
        )}
      >
        <svg
          fill="none"
        ...
        >
          ...
          <path
            className={clsx(
              activeNavar === "parse" ? "stroke-[#ff4f00]" : "stroke-[#808080]",
            )}
            strokeLinecap="round"
            strokeLinejoin="round"
            strokeWidth="1.5"
          ...
          <path
            className={clsx(
              activeNavar === "parse" ? "stroke-blue-400" : "stroke-[#808080]",
            )}
            strokeLinecap="round"
            strokeLinejoin="round"
            strokeWidth="1.5"
        ...
        <p
          className={clsx(
            "text-[11px]",
            activeNavar === "parse" ? "text-blue-400" : "text-[#808080]",
          )}
        >
          {t("mainPage.parse")}
        </p>
